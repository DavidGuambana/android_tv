...
public class MainFragment extends BrowseSupportFragment {
    ...
    private void loadRows() {
        ...
        for (int categoryIndex = 0; categoryIndex < MovieList.MOVIE_CATEGORY.length; categoryIndex++) {
            ...
            HeaderItem header = new HeaderItem(categoryIndex, MovieList.MOVIE_CATEGORY[categoryIndex]);
    ...
    private void setupUIElements() {
        ...
        setBrandColor(ContextCompat.getColor(getContext(), R.color.categorias_background));
